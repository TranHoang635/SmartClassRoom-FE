...
@Component({
  selector: 'app-ds-giangvien',
  templateUrl: './ds-giangvien.component.html',
  styleUrls: ['./ds-giangvien.component.css']
})
export class DsGiangvienComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.value !== 2) { // nếu loaiuser khác 4 thì gán value = 4 và tải lại danh sách
      this.value = 2;
